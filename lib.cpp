...
const char fileLibrarianAccount[50] = "fileaccountLibrarian.txt";
...
public:
    ...
    void insert_first(string Book_name, string Book_type, string Book_language, double price, string author, bool available)
    { // insert the book at first position
    ...
    bool insert_After(string Current_book, string Book_name1, string Book_type, string Book_language, double price, string author, bool available)
    { // inserts the book after the book required
        transform(author.begin(), author.end(), author.begin(), ::tolower);
    ...
    void update_first(string new_Book_name, string new_Book_type, string new_Book_language, double new_price, string new_author)
    { // update information of the first position book
    ...
    void update_last(string new_Book_name, string new_Book_type, string new_Book_language, double new_price, string new_author)
    { // update information of the last position book
        transform(new_author.begin(), new_author.end(), new_author.begin(), ::tolower);
        transform(new_Book_name.begin(), new_Book_name.end(), new_Book_name.begin(), ::tolower);
        transform(new_Book_type.begin(), new_Book_type.end(), new_Book_type.begin(), ::tolower);
        transform(new_Book_language.begin(), new_Book_language.end(), new_Book_language.begin(), ::tolower);
    ...
    void update_at(string replaced_book, string new_Book_name, string new_Book_type, string new_Book_language, double new_price, string new_author)
    { // update information of  a certain book book
        transform(new_author.begin(), new_author.end(), new_author.begin(), ::tolower);
        transform(new_Book_name.begin(), new_Book_name.end(), new_Book_name.begin(), ::tolower);
        transform(new_Book_type.begin(), new_Book_type.end(), new_Book_type.begin(), ::tolower);
        transform(new_Book_language.begin(), new_Book_language.end(), new_Book_language.begin(), ::tolower);
    ...
    void SearchingBook(string FidingName, TypeSearching searchtype)
    {
        ...
        if (!fileAccount.is_open())
        {
            cout << RED << "           Library is empty" << endl
                 << endl;
            DeFaultColor();
            return;
        }
        ...
        while (fileAccount >> bookFind.Book_type >> bookFind.Book_name >> bookFind.Book_language >> bookFind.author >> bookFind.price)
        {
            ...
            if (strcmp(bookFindname, bookname) == 0)
            {
                ...
                cout << "        "
                     << "Book type: " << bookFind.Book_type << endl;
                cout << "        "
                     << "Book language: " << bookFind.Book_language << endl;
                cout << "        "
                     << "Book price: " << bookFind.price << endl;
                cout << "        "
                     << "Book author: " << bookFind.author << endl;
                cout << endl;
                count++;
            }
        }
        if (count == 0)
        {
            cout << RED << "          Book is not found" << endl
                 << endl;
            DeFaultColor();
        }
        fileAccount.close();
    ...
    void sortListWithPrice()
    { // sort all book by price
        Book *current;
        Book *q;
        current = head;
        q = NULL;
    ...
    void traversal() // displays the books in the library
    {
        ...
        else
        {
            ...
            while (nextBook != NULL)
            {
                ...
                cout << "       Price:" << nextBook->price << "       " << endl
                     << endl;
...
public:
    void DoLogin()
    {
        cout << "Login as Librarian or user ?" << endl;
        string name;
        do
        {
            getline(cin, name);
            transform(name.begin(), name.end(), name.begin(), ::tolower);
            if (name != "Librarian" && name != "user")
            {
                cout << "Please enter a valid Choice" << endl;
            }
        } while (name != "Librarian" && name != "user");
        if (name == "Librarian")
        {
            LibrarianLogin();
        }
    ...
    void LibrarianLogin()
    {
        isSuccess = StartLogin(fileLibrarianAccount, true);
        if (isSuccess)
        {
            while (true)
            {
...
public:
    void DoSignUp()
    {
        cout << "Sign Up as Librarian or user ?" << endl;
        string name;
        do
        {
            getline(cin, name);
...
private:
    ...
    {
        if (StartSignUp(fileLibrarianAccount, true))
        {
            cout << "Create Librarian account successfully";
        }
        else
        {
    ...
    bool StartSignUp(const char *fileName, bool isLibrarian)
    {
        char adminPasss[50];
        Account A;
        cout << "New Name: ";
